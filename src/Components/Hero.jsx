    ...
    <div className="border-2 border-lines-color rounded">
      <div className="h-[80vh] flex flex-col justify-center max-w-2xl mx-auto items-center gap-5">
        ...
        <a href="/Ahmed Mohamed Hussin (CV).pdf" download>
          <button class="cursor-pointer group relative flex gap-1.5 px-8 py-4 bg-[#111113] bg-opacity-80 text-[#f1f1f1] rounded-3xl hover:bg-opacity-70 transition font-semibold shadow-md border-2 border-lines-color">
            <svg
