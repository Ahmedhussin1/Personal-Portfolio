    ...
    <div className="pb-10">
      <div className="grid grid-cols-3 border-2 border-lines-color rounded border-t-0 ">
        ...
        <div className="col-span-1 flex gap-5 p-5">
          <div>
            <button className="cursor-pointer group relative flex gap-1.5 px-7 py-4 bg-[#111113] bg-opacity-80 text-[#f1f1f1] rounded-3xl hover:bg-opacity-70 transition font-semibold shadow-md border-2 border-lines-color">
              <svg
          ...
          <div>
            <button className="cursor-pointer group relative flex items-center gap-1.5 px-7 py-4 bg-[#111113] bg-opacity-80 text-[#f1f1f1] rounded-3xl hover:bg-opacity-70 transition font-semibold shadow-md border-2 border-lines-color">
              <FaRegPaperPlane />
              Contact Me
              <div className="absolute opacity-0 -bottom-full rounded-md py-2 px-2 bg-[#161617] bg-opacity-70 left-1/2 -translate-x-1/2 group-hover:opacity-100 transition-opacity shadow-lg">
                contact me
